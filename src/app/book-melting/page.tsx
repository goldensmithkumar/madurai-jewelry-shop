...
import { createMeltingBooking } from "./actions";
import Image from "next/image";

export default function BookMeltingPage() {
        ...
        <div className="min-h-screen bg-[#0a0a0a]">
            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/images/gold-melting-v4.png"
                        alt="Gold Melting"
                        fill
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-24 pb-12">
                    <div className="inline-block px-4 py-1 rounded-full border border-gold/30 bg-gold/5 text-gold text-[10px] uppercase tracking-[0.5em] mb-8">
                        {t.services.melting.subtitle}
                    </div>

                    <h1 className="text-5xl md:text-8xl font-serif mb-8 leading-tight gold-text drop-shadow-[0_0_30px_rgba(212,175,55,0.3)]">
                        {t.services.melting.title}
                    </h1>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-[10px] uppercase tracking-widest text-gold/60">High Temp</span>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="text-3xl mb-3">⚖️</div>
                            <span className="text-[10px] uppercase tracking-widest text-gold/60">Accurate</span>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="text-3xl mb-3">🛡️</div>
                            <span className="text-[10px] uppercase tracking-widest text-gold/60">Secure</span>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="text-3xl mb-3">💎</div>
                            <span className="text-[10px] uppercase tracking-widest text-gold/60">Purest Form</span>
                        </div>
                    </div>
            ...
            <section ref={formRef} className="py-32 px-6 bg-[#0a0a0a] relative">
                ...
                <div className="max-w-2xl mx-auto glass p-8 md:p-14 rounded-[3rem] border border-white/5 shadow-2xl relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-12 text-white/[0.02] text-9xl font-serif font-black pointer-events-none">MELT</div>
                    ...
                    {success ? (
                        <div className="text-center py-12 animate-fade-in">
                            ...
                            <h3 className="text-2xl font-serif mb-4">Service Requested!</h3>
                            <p className="text-gray-400 mb-8">We will contact you to coordinate the gold melting process.</p>
                        ...
                        <form
                            action={async (formData) => {
                                ...
                                setError("");
                                try {
                                    await createMeltingBooking(formData);
                                    setSuccess(true);
                                } catch (e: any) {
                        ...
                        >
                            ...
                            <div className="group space-y-3">
                                ...
                                <textarea
                                    ...
                                    placeholder="Describe your gold items (e.g. 5 old rings, 1 chain)..."
                                />
                            </div>
                            ...
                            {error && (
                                <div className="bg-red-400/10 border border-red-400/20 p-5 rounded-2xl text-red-400 text-[11px] uppercase font-black tracking-widest flex items-center justify-center gap-3">
                                    <span>⚠️</span> {error}
                                </div>
                            )}
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-6 mt-4 bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 text-black font-black uppercase tracking-[0.4em] rounded-2xl hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-gold/40 disabled:opacity-50 relative overflow-hidden group"
                            >
